export const dom = {
  ...
  newTicketToggleButton: document.querySelector("#new-ticket-toggle-button"),
  newTicketCloseButton: document.querySelector("#new-ticket-close-button"),
  ...
  ticketCreatePanel: document.querySelector("#ticket-create-panel"),
  opsTabGroup: document.querySelector("#ops-tab-group"),
  ...
  detailTabGroup: document.querySelector("#detail-tab-group"),
